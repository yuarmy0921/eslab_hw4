...
public:
    HeartrateDemo(BLE &ble, events::EventQueue &event_queue) :
        ...
        _magneto_uuid(GattService::UUID_ENVIRONMENTAL_SERVICE),
        _magneto_x_value(0),
        _magneto_y_value(0),
        _magneto_z_value(0),
...
private:
    ...
    UUID _magneto_uuid;
    int16_t _magneto_x_value, _magneto_y_value, _magneto_z_value;
